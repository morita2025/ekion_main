classdef CalcOperatorPrm_ekion < handle
    ...
    properties (Constant ,Access = private) %Constのproperty
        constPrivatePrm = struct("d",[0.12; 0.07; 0.03; 0.03; 0.02; 0.01; 0.01; 0.02],...
                                 "S",[2.6e-3; 7e-4; 9.8e-3; 9e-4; pi*9e-6; pi*3e-4; 1.4e-3; 2.8e-4; pi*1.2e-4; 0.49*pi*9e-6; 0.7*pi*3e-4; 0.7*pi*1.2e-4],...
                                 "aluminum", struct("density",2500,"thermalCond",150,"specificHeat",250,"emissivity",0.2),...
                                 "tube", struct("density",970.2,"thermalCond",0.2,"specificHeat",1600,"emissivity",0.93),...
                                 ...
                                 "peltier",  struct("seebeck",0.08,"thermalConductance",0.43,"resistance",2,"absoluteTemperature",273.15)...
                                 );
    end
    ...
    methods
        function obj = CalcOperatorPrm_ekion(options)
            ...
            arguments
                ...
                options.heatTransferCoef_liquid {mustBeNumeric} = 300;%α_l 
            ...
            %% 干渉の定数
            obj.interferrencePrm = struct("y_a",obj.aluminum.thermalCond*S(3,1) ./[dx13; dx2; dx13], ..../ obj.aluminum.dx,...
                                          "y_aw",obj.tube.heatTransferCoef.*[S(6,1);S(9,1);S(6,1)],...
                                          "y_w",obj.tube.thermalCond*(S(5,1) - S(10,1))./ obj.tube.dx,... ???????
